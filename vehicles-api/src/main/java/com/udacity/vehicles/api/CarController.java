...
@ApiResponses(value = {
        ...
        @ApiResponse(code = 404, message = "The request cannot be found, please try again"),
        @ApiResponse(code=500, message = "The server is down. Please make sure that the Vehicle is running.")
})
class CarController {
